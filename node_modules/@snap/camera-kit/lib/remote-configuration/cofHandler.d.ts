...
export declare const cofHandlerFactory: {
    (args_0: CameraKitConfiguration, args_1: RequestStateEventTarget, args_2: OperationalMetricsReporter): import("../handlers/HandlerChainBuilder").Handler<Partial<ConfigTargetingRequest>, ConfigTargetingResponse, Metadata & {
